...
<body style="background-color:white">
    <header class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="width:999px; height:150px; margin-left:auto; margin-right:auto; padding-left:0px; text-align:left; border: 1px solid #ccc; background-color:white">
        ...
        <div style="width:1000px; font-size:40px; font-family:Comic Sans MS; text-align:center;"><span style="color:#77a8da; text-align:center;">■</span>slackers</div>
        <div style="text-align:center;">バンドメンバーが見つかるサイト</div>
        </div>
        @else
        <div style="width:990px; font-size:40px; font-family:Comic Sans MS; text-align:center; background-color:white"><span style="color:#77a8da; text-align:center;">■</span>slackers</div>
        <div style="text-align:center;">バンドメンバーが見つかるサイト</div>
    ...
    <main style="width:1000px; height:100%; min-height:1000px; display:table; margin-left: 212px; margin-right:auto;">
        @if(Auth::check())
        <div style="display:inline-block; vertical-align:top; width:200px; height:100%; min-height:1000px; border: 1px solid #ccc; border-top-style:none; background-color:#f7f7f7;">
            <div class="" style="">
                ...
                <div><a class="link" href="{{ url('profile') }}">マイページ</a></div>
                <div class="">
            ...
            <div style="border-top: 1px solid #ccc;"><i class="fas fa-search" style="margin-right:2px; margin-left:2px; color:#51565a;"></i>探す
                ...
                <div><a class="link" href="{{ url('index_articlelist') }}">記事</a></div>
            </div>
        ...
        <div style="display:inline-block; width:799px; height:100%; min-height:1000px; border:1px solid #ccc; border-top-style:none; border-left-style:none;">
            @yield('content')
        </div>
        @else
