@extends('main')
@section('content')
    <div style="display:table-cell; height:1000px; margin-left:auto; margin-right:auto; padding-left:0px;">
        ...
        <div style="width:788px; display:inline-block; margin-left:auto; margin-right:auto;">
            ...
            <div class="pulldown" data-slide="slide{{$show->user_detail->id}}" style="border-bottom: 1px solid #ccc; margin-left:3px; padding-top:5px; padding-bottom:5px;">
                <div>{{$show->title}}</div>
